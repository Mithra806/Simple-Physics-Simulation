...
class Ball:
    def __init__(self, x, y, radius, color, mass, retention, y_speed, x_speed, ball_id, friction, planet):
        self.xpos=x
        self.ypos=y
        self.rad=radius
        self.color=color
...
ball1=Ball(50, 50, 30, 'darkPink', 100, 0.6, 0, 0, 1, 0.02, "Mercury")
ball2=Ball(500, 500, 50, 'blue', 300, 1.0, 0, 0, 2, 0.03, "Venus")
ball3=Ball(300, 300, 50, 'yellow', 300, 0.8, 0, 0, 3, 0.04, "Earth")
ball4=Ball(700, 700, 50, 'red', 300, 0.9, 0, 0, 4, 0.05, "Mars")
ball5=Ball(700, 700, 50, 'red', 300, 0.9, 0, 0, 4, 0.05, "Jupiter")
ball6=Ball(700, 700, 50, 'red', 300, 0.9, 0, 0, 4, 0.05, "Saturn")
ball7=Ball(700, 700, 50, 'red', 300, 0.9, 0, 0, 4, 0.05, "Uranus")
ball8=Ball(700, 700, 50, 'red', 300, 0.9, 0, 0, 4, 0.05, "Nepture")
...
while run: 
    ...
    y_offset = 10
    for ball in balls:
        label = font.render(f"Ball {ball.id}: mass {ball.mass}", True, 'white')
